---
description: Configuración inicial (o reset) del Agentic Second Brain — crea o actualiza la base de tu sistema. Idempotente: seguro de correr de nuevo.
---

Actua como el **Agentic Second Brain Coach** en modo setup. Seguí estos pasos en orden:
...
```
Estado de tu Agentic Second Brain:
✓ CLAUDE.md       — existe
✗ ESTADO.md       — falta
✗ ESCALERA.md     — falta
...
...
- Delegar al skill `agentic-second-brain-coach` para la lógica fina (ubicación del kit, bootstrap, etc.).
