---
description: Muestra tu progreso en la escalera del Agentic Second Brain y propone el próximo paso concreto.
---
...
5. **Si no existe `ESCALERA.md`** — avisá que el Agentic Second Brain todavía no está armado y ofrecé correr `/agentic-second-brain-setup`.
