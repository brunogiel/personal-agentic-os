...
1. **[DET]** Leer la versión publicada del kit (el archivo `VERSION` del repo) y compararla con la instalada (`~/.claude/skills/agentic-second-brain-coach/VERSION`).
...
## Flujo
1. [DET] Leé la versión publicada (VERSION del repo) y la instalada (~/.claude/skills/agentic-second-brain-coach/VERSION).
