...
- **`council`:** en el N5, el orquestador de ejemplo **multi-agente** — corre una decisión por 5 asesores en paralelo + peer-review + síntesis. Ofrecelo también suelto cuando el usuario trae una decisión real con stakes ("no me decido entre X e Y").
